"""
Experiment Number: 8
File Name: experiment_8.py
Description: Write a Pandas program to create a Pivot table and find the item wise unit sold.
"""
...
def main():
    ...
    pivot_table = pd.pivot_table(df, index='Item', values='Units', aggfunc='sum')
