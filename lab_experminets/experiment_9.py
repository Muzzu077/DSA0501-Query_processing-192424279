"""
Experiment Number: 9
File Name: experiment_9.py
Description: Write a Pandas program to create a Pivot table and find the total sale amount region wise, manager wise, sales man wise.
"""
